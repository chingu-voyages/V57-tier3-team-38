...
//   }
  ...
  return (
    <div>
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center bg-gray-900 border-b h-auto lg:h-12 lg:w-full w-auto
         border-b-[#30363D] justify-between py-3 lg:py-0 space-y-3 lg:space-y-0">
             {/* Adjust height for lg screens to be 48px and for smaller screens to be auto */}
                ...
                <div className="flex items-center">
                    <div className="relative w-full lg:w-auto"> {/* Adjusted for large screens to have the dropdown and search bar to be full and otherwise auto*/}
                        <button onClick={toggleRepoDropdown} className="lg:w-auto lg:h-auto cursor-pointer ml-8 w-[510px] h-[34px] bg-slate-950 border border-[#30363D]  rounded-lg px-3 py-1.5 
                        ...
                        {isRepoDropdownOpen && (
                        <div id="repoDropdown" className={`absolute left-0 mt-2 ml-10 overflow-y-auto thin-scrollbar 
                        bg-[#0d1117] border border-[#30363D] w-[510px] h-[300px] lg:max-w-[200px] lg:max-h-[254px] rounded-lg shadow-lg z-50 ${isRepoDropdownOpen ? '' : 'hidden'}`}>
                          <div className="p-3">
                            <input type="text" id="repoSearch" placeholder="Search repositories..." className="w-full lg:w-auto lg:h-auto bg-slate-950 border border-[#30363D] rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"/>
                          </div>
                ...
                <div className="flex-1 lg:max-w-md lg:mx-8 px-8">
                    <div className="relative">
                        <input type="text" id="globalSearch" placeholder="Search PRs..." 
                        className="w-[510px] h-auto lg:h-[34px] lg:w-[500px] bg-slate-950 border border-[#30363D] rounded-lg pl-9 pr-4 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"/>
