...
//   }
  ...
  return (
    <div>
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center bg-gray-900 border-b h-full lg:h-12 w-[653px] lg:w-full
             ...
             {/* Adjust height for lg screens to be 48px and for smaller screens to be auto */}
                ...
                <div className="flex items-center">
                    <div className="relative w-full lg:w-auto"> {/* Adjusted for large screens to have the dropdown and search bar to be full and otherwise auto*/}
                        ...
                        {isRepoDropdownOpen && (
                        <div id="repoDropdown" className={`absolute left-0 mt-2 w-full ml-10 overflow-y-auto thin-scrollbar 
                        lg:w-64 bg-[#0d1117] border border-[#30363D] max-w-[200px] max-h-[254px] rounded-lg shadow-lg z-50 ${isRepoDropdownOpen ? '' : 'hidden'}`}>
                          <div className="p-3">
                ...
                <div className="flex-1 lg:max-w-md lg:mx-8 px-8">
                    <div className="relative">
                        ...
                        className="h-[34px] lg:h-full w-[605px] lg:w-full bg-slate-950 border border-[#30363D] rounded-lg pl-9 pr-4 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"/>
